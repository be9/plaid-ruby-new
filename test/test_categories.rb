...
class PlaidCategoriesTest < MiniTest::Test
  include TestHelpers
  ...
  def test_get_single_category
    ...
    assert_equal :place, cat.type
    assert_equal ["Shops", "Clothing and Accessories", "Swimwear"], cat.hierarchy
  end
  ...
  def test_get_nonexistent_category
    ...
    assert_equal 'Code 1501: unable to find category. Double-check the provided category ID.', e.message
  end
end
